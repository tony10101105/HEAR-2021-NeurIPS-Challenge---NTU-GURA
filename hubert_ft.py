...
def load_model(
    model_file_path: str = "", model_hub: str = "facebook/hubert-large-ls960-ft"
) -> torch.nn.Module:
    """
    ...
    elif model_hub.startswith("facebook/hubert-large"):
...
def get_timestamp_embeddings(
    ...
    if not isinstance(model, HubertForCTC):
        raise ValueError(f"Model must be an instance of {HubertForCTC.__name__}")
